    ...
    <div className="space-y-6">
      ...
      <header className="mb-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="px-5 py-3 bg-primary hover:opacity-90 text-on-primary rounded-[8px] text-sm font-bold flex items-center gap-2 transition-all duration-200 active:scale-95 shadow-md w-fit"
        >
      ...
      <div className="flex gap-2 border-b border-slate-200 pb-1">
        {(
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-3 rounded-t-[8px] text-sm font-bold transition-all border-b-2 -mb-1.5 focus:outline-none ${
              activeTab === tab.key
      ...
      {/* Loading overlay */}
      {loading ? (
        <div className="bg-white rounded-[8px] p-16 border border-slate-100 shadow-sm flex flex-col items-center justify-center min-h-[400px]">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                {[
                  ...
                  <div key={idx} className="bg-white px-5 py-4 rounded-[8px] shadow-sm border border-slate-100 flex items-center justify-between hover:shadow-md transition-all duration-300 animate-in fade-in duration-300">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-[8px] border flex items-center justify-center shrink-0 ${kpi.color}`}>
              ...
              <div className="p-6 border-b border-slate-100 flex flex-wrap items-center gap-4 bg-slate-50/50">
                <div className="flex-1 min-w-[260px] relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-[8px] font-semibold text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-rose-400/20 focus:border-rose-400 transition-all"
                  />
                </div>
                {searchTerm && (
                  <button
                ...
                <div className="p-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 border border-slate-200 rounded-[8px] text-sm font-bold bg-white text-slate-600 hover:bg-primary hover:text-on-primary transition-colors disabled:opacity-50 disabled:hover:bg-white disabled:hover:text-slate-600"
                    >
                      Trước
                    </button>
                    <button
            ...
            <div className="space-y-4">
              <div className="flex justify-end">
                <button
                  ...
                  className="px-4 py-2.5 bg-primary hover:opacity-90 text-on-primary rounded-[8px] text-sm font-bold flex items-center gap-1.5 transition-all duration-200 active:scale-95 shadow-sm cursor-pointer"
                >
                      ...
                      {templates.length === 0 ? (
                        ...
                        templates.map((tpl, index) => (
                          <tr key={tpl.id} className="hover:bg-slate-100/70 transition-all duration-200 group">
                            ...
                            <td className="px-6 py-4">
                              {tpl.isActive ? (
                                <span className="px-2.5 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-[8px] text-[10px] font-bold">Kích hoạt</span>
                              ) : (
                                <span className="px-2.5 py-1 bg-slate-50 text-slate-400 border border-slate-100 rounded-[8px] text-[10px] font-bold">Tắt</span>
                              )}
                            </td>
      ...
      {templateModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-[8px] w-full max-w-[32rem] shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleTemplateSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-[8px] text-sm font-medium focus:outline-none focus:ring-1 focus:ring-primary focus:bg-white text-slate-800"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-[8px] text-sm font-mono font-bold focus:outline-none focus:ring-1 focus:ring-primary focus:bg-white text-slate-800"
              ...
              <div className="pt-4 border-t border-slate-100 flex justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setTemplateModalOpen(false)}
                  className="px-4 py-2 border border-slate-200 text-slate-600 rounded-[8px] text-xs font-bold hover:bg-slate-50"
                >
                  Hủy
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 bg-primary text-on-primary rounded-[8px] text-sm font-bold hover:opacity-90"
                >
      ...
      {confirmModal.show && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
          ...
          />
          <div className="bg-white rounded-[8px] p-6 shadow-xl border border-slate-100 max-w-[380px] w-full relative z-10 transform scale-100 transition-all duration-300 animate-in fade-in zoom-in-95">
            ...
            <div className="flex justify-end gap-2">
              <button
                onClick={() => setConfirmModal(prev => ({ ...prev, show: false }))}
                className="px-4 py-2 border border-slate-200 hover:bg-slate-50 rounded-[8px] text-[11px] font-bold text-slate-600 transition-colors"
              >
                Hủy bỏ
              </button>
              <button
                onClick={confirmModal.onConfirm}
                className="px-4 py-2 bg-error hover:bg-error/90 text-white rounded-[8px] text-sm font-bold transition-all shadow-md active:scale-95"
              >
                Xác nhận
              </button>
            </div>
