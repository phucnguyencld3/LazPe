...
export const EmptyCart: React.FC = () => {
  return (
    <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-slate-100 space-y-6 max-w-2xl mx-auto my-12">
      <div className="w-20 h-20 rounded-[16px] bg-primary/5 text-slate-900 flex items-center justify-center mx-auto shadow-inner">
        <ShoppingBag size={36} />
      </div>
      ...
      <div className="pt-4">
        <Link
          href="/products"
          className="bg-primary hover:bg-primary/90 text-white px-8 py-3.5 rounded-[8px] font-bold shadow-md shadow-primary/10 transition-all inline-block hover:scale-105 active:scale-95"
        >
