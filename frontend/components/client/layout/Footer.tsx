        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 md:space-y-1 text-xs md:text-sm text-on-surface-variant">
              ...
              <li><strong>VP:</strong> Tầng 99 Phú Mỹ Hưng Tower, 08 Hoàng Văn Thái, P.Tân Mỹ, Tp.HCM</li>
            </ul>

            <div className="pt-2">
              <p className="text-xs font-semibold mb-1">Mua hàng & CSKH: <span className="text-primary font-bold text-sm">1900 1234</span> (Free)</p>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-1 text-sm md:text-xs text-on-surface-variant">
              ...
              <li><Link href="/profile" className="hover:text-primary transition-colors">Gói Hội Viên</Link></li>
