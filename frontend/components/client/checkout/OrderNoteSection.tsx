      ...
      <div className="space-y-3">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full h-24 rounded-[8px] border border-slate-200 focus:border-rose-500 focus:ring-1 focus:ring-rose-500/20 p-4 font-sans text-sm bg-slate-50/50 resize-none transition-all outline-none"
