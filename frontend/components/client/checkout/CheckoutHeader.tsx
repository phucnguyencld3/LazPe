...
export const CheckoutHeader: React.FC = () => {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between mb-8 pb-4 border-b border-slate-200">
      <Link
        href="/cart"
        className="flex items-center gap-2 text-slate-500 hover:text-slate-900 font-semibold transition-colors group mb-4 sm:mb-0"
      >
      ...
      <div className="flex items-center space-x-3 text-sm">
        ...
        <div className="flex items-center text-slate-900 font-semibold">
          <span className="w-6 h-6 rounded-[8px] bg-primary text-white flex items-center justify-center font-bold text-xs mr-2 shadow-sm">2</span>
