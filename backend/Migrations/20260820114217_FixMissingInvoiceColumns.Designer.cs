...
namespace PolyBabyAPI.Migrations
{
    ...
    [Migration("20260820114217_FixMissingInvoiceColumns")]
    partial class FixMissingInvoiceColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolyBabyAPI.Models.LoyaltyVoucherRedemption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("LimitPerUserPerPeriod")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TotalQuotaPerPeriod")
                        .HasColumnType("int");
                    ...
                    b.ToTable("LoyaltyVoucherRedemptions");
                });

            modelBuilder.Entity("PolyBabyAPI.Models.LoyaltyVoucherRedemptionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LoyaltyVoucherRedemptionHistories");
                });
            ...
            modelBuilder.Entity("PolyBabyAPI.Models.Banner", b =>
                {
                    b.OwnsOne("PolyBabyAPI.Models.BannerLayoutConfig", "DraftConfig", b1 =>
                        {
                            ...
                            b1.ToJson("DraftConfig");

                            b1.WithOwner()
                                .HasForeignKey("BannerId");

                            b1.OwnsOne("PolyBabyAPI.Models.BannerFloatingConfig", "FloatingConfig", b2 =>
                                {
                                    ...
                                    b2.Property<bool?>("CloseSession")
                                        .HasColumnType("bit");

                                    b2.Property<bool?>("Closeable")
                                        .HasColumnType("bit");
                                    ...
                                    b2.OwnsOne("PolyBabyAPI.Models.BannerFloatingPosition", "DesktopPosition", b3 =>
                                        {
                                            b3.Property<int>("BannerFloatingConfigBannerLayoutConfigBannerId")
                                                .HasColumnType("int");

                                            b3.Property<string>("Anchor")
                                                .IsRequired()
                                                .HasColumnType("nvarchar(max)");

                                            b3.Property<double?>("OffsetX")
                                                .HasColumnType("float");

                                            b3.Property<double?>("OffsetY")
                                                .HasColumnType("float");

                                            b3.HasKey("BannerFloatingConfigBannerLayoutConfigBannerId");

                                            b3.ToTable("Banners");

                                            b3.WithOwner()
                                                .HasForeignKey("BannerFloatingConfigBannerLayoutConfigBannerId");
                                        });

                                    b2.OwnsOne("PolyBabyAPI.Models.BannerFloatingPosition", "MobilePosition", b3 =>
                                        {
                                            b3.Property<int>("BannerFloatingConfigBannerLayoutConfigBannerId")
                                                .HasColumnType("int");
                                    ...
                                    b2.OwnsOne("PolyBabyAPI.Models.BannerFloatingPosition", "TabletPosition", b3 =>
                                        {
                                            b3.Property<int>("BannerFloatingConfigBannerLayoutConfigBannerId")
                                                .HasColumnType("int");
                                    ...
                                    b2.Navigation("DesktopPosition");

                                    b2.Navigation("MobilePosition");

                                    b2.Navigation("TabletPosition");
                                });
                            ...
                            b1.OwnsMany("PolyBabyAPI.Models.BannerItem", "Items", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("PolyBabyAPI.Models.BannerRedirectConfig", "Redirect", b3 =>
                                        {
                                            b3.Property<int>("BannerItemBannerLayoutConfigBannerId")
                                                .HasColumnType("int");

                                            b3.Property<int>("BannerItemId")
                                                .HasColumnType("int");

                                            b3.Property<string>("ResolvedUrl")
                                                .HasColumnType("nvarchar(max)");
                                            ...
                                            b3.HasKey("BannerItemBannerLayoutConfigBannerId", "BannerItemId");

                                            b3.ToTable("Banners");

                                            b3.WithOwner()
                                                .HasForeignKey("BannerItemBannerLayoutConfigBannerId", "BannerItemId");
                                        });

                                    b2.Navigation("Redirect");
                                });
                            ...
                            b1.OwnsOne("PolyBabyAPI.Models.BannerFloatingConfig", "FloatingConfig", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("PolyBabyAPI.Models.BannerFloatingPosition", "DesktopPosition", b3 =>
                                        {
                                            b3.Property<int>("BannerFloatingConfigBannerLayoutConfigBannerVersionId")
                                                .HasColumnType("int");
                                            ...
                                            b3.HasKey("BannerFloatingConfigBannerLayoutConfigBannerVersionId");

                                            b3.ToTable("BannerVersions");

                                            b3.WithOwner()
                                                .HasForeignKey("BannerFloatingConfigBannerLayoutConfigBannerVersionId");
                                        });
                            ...
                            b1.OwnsMany("PolyBabyAPI.Models.BannerItem", "Items", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("PolyBabyAPI.Models.BannerRedirectConfig", "Redirect", b3 =>
                                        {
                                            b3.Property<int>("BannerItemBannerLayoutConfigBannerVersionId")
                                                .HasColumnType("int");
                                            ...
                                            b3.HasKey("BannerItemBannerLayoutConfigBannerVersionId", "BannerItemId");

                                            b3.ToTable("BannerVersions");

                                            b3.WithOwner()
                                                .HasForeignKey("BannerItemBannerLayoutConfigBannerVersionId", "BannerItemId");
                                        });
            ...
            modelBuilder.Entity("PolyBabyAPI.Models.LoyaltyVoucherRedemptionHistory", b =>
                {
                    ...
                    b.HasOne("PolyBabyAPI.Models.UserVoucher", "UserVoucher")
                        .WithMany()
