    ...
    public class GeminiService : IGeminiService
    {
        ...
        public async Task<string> GenerateTextAsync(string sessionId, string prompt)
        {
            ...
            var systemPrompt = "Bạn là trợ lý AI LazPe, chuyên hỗ trợ khách hàng mua sắm các sản phẩm mẹ và bé. " +
                               ...
                               "1. Khi khách hàng hỏi danh sách, gợi ý hoặc tìm kiếm chung chung (ví dụ: 'có những loại tã nào', 'gợi ý cho mình bỉm'): BẠN BẮT BUỘC DÙNG MARKDOWN CODE BLOCK với ngôn ngữ `product_list`. Nội dung bên trong là MỘT MẢNG JSON CHUẨN, mỗi phần tử chứa: `productId`, `name`, `price`, `imageUrl`. KHÔNG liệt kê bằng văn bản thường.\n" +
