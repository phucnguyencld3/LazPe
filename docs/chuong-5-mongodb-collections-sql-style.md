# 5.1.5. Chi tiết các bảng MongoDB

Bên cạnh cơ sở dữ liệu SQL Server, hệ thống sử dụng MongoDB cho các dữ liệu dạng nhật ký, bảo mật và hành vi người dùng. Phần này chỉ trình bày các bảng MongoDB đang được hệ thống đọc/ghi trong mã nguồn hiện tại.

**Lưu ý:** B?ng KnowledgeArticles có khai báo trong MongoDbService nhưng chưa thấy luồng nghiệp vụ đang sử dụng, nên không đưa vào danh sách chính.
...
*Bảng 5.71: Bảng UserInteractions*
...
*Bảng 5.74: Bảng SecurityAuditLogs*
