...
**Đường dẫn:** https://lazpe.store/login, https://lazpe.store/register, https://lazpe.store/verify-otp, https://lazpe.store/forgot-password, https://lazpe.store/reset-password
...
**Đường dẫn:** https://lazpe.store/products
...
**Đường dẫn:** https://lazpe.store/products/[id]
...
**Đường dẫn:** https://lazpe.store/cart
...
**Đường dẫn:** https://lazpe.store/checkout
...
**Đường dẫn:** https://lazpe.store/profile
...
**Đường dẫn:** https://lazpe.store/rewards, https://lazpe.store/vouchers
...
**Đường dẫn:** https://lazpe.store/order-tracking, https://lazpe.store/Invoice
...
**Đường dẫn:** https://lazpe.store/wishlist, https://lazpe.store/compare, https://lazpe.store/notifications
...
**Đường dẫn:** https://lazpe.store/baby-timeline/[id]
...
**Đường dẫn:** https://lazpe.store/admin
...
**Đường dẫn:** https://lazpe.store/admin/products, https://lazpe.store/admin/products/new, https://lazpe.store/admin/products/edit/[id], https://lazpe.store/admin/products/[id]/options, https://lazpe.store/admin/products/[id]/variants
...
**Đường dẫn:** https://lazpe.store/admin/categories, https://lazpe.store/admin/brands
...
**Đường dẫn:** https://lazpe.store/admin/orders, https://lazpe.store/admin/orders/[id], https://lazpe.store/admin/orders/[id]/print, https://lazpe.store/admin/orders/batch-print
...
**Đường dẫn:** https://lazpe.store/admin/vouchers, https://lazpe.store/admin/flash-sales, https://lazpe.store/admin/combo
...
**Đường dẫn:** https://lazpe.store/admin/users, https://lazpe.store/admin/users/[id], https://lazpe.store/admin/permissions, https://lazpe.store/admin/role-templates
...
**Đường dẫn:** https://lazpe.store/admin/reviews
...
**Đường dẫn:** https://lazpe.store/admin/loyalty
...
**Đường dẫn:** https://lazpe.store/admin/banners, https://lazpe.store/admin/notifications
...
**Đường dẫn:** https://lazpe.store/admin/statistics
...
**Đường dẫn:** https://lazpe.store/admin/blocked-ips, https://lazpe.store/admin/security-logs
...
**Đường dẫn:** https://lazpe.store/admin/chats, https://lazpe.store/admin/subscriptions, https://lazpe.store/admin/withdrawals, https://lazpe.store/admin/profile
...
|---|---|---|---|---|
| 1 | Chính | Trang chủ | https://lazpe.store/ | Chụp header, banner chính, flash sale, voucher và sản phẩm nổi bật. |
| 2 | Chính | Đăng nhập | https://lazpe.store/login | Chụp form đăng nhập, nút đăng nhập Google và liên kết quên mật khẩu. |
| 3 | Chính | Đăng ký | https://lazpe.store/register | Chụp form đăng ký có đầy đủ thông tin cá nhân. |
| 4 | Phụ trọng tâm | Xác thực OTP | https://lazpe.store/verify-otp | Chụp màn hình nhập mã OTP và nút xác nhận. |
| 5 | Chính | Danh sách sản phẩm | https://lazpe.store/products | Chụp lưới sản phẩm kèm bộ lọc danh mục, thương hiệu và giá. |
| 6 | Phụ trọng tâm | Tìm kiếm sản phẩm | https://lazpe.store/products | Chụp trạng thái sau khi nhập từ khóa hoặc dùng tìm kiếm nâng cao. |
| 7 | Phụ trọng tâm | Modal thêm nhanh giỏ hàng | https://lazpe.store/products | Chụp QuickAddModal khi chọn biến thể và số lượng. |
| 8 | Chính | Chi tiết sản phẩm | https://lazpe.store/products/[id] | Chụp ảnh sản phẩm, thông tin, giá, biến thể và nút mua hàng. |
| 9 | Phụ trọng tâm | Tab mô tả/thông số sản phẩm | https://lazpe.store/products/[id] | Chụp phần tab nội dung mô tả hoặc thông số kỹ thuật. |
| 10 | Phụ trọng tâm | Tab đánh giá sản phẩm | https://lazpe.store/products/[id] | Chụp danh sách đánh giá, điểm sao và phản hồi. |
| 11 | Phụ trọng tâm | Cảnh báo hoặc mua định kỳ | https://lazpe.store/products/[id] | Chụp ProductAlertModal hoặc SubscriptionModal. |
| 12 | Chính | Giỏ hàng | https://lazpe.store/cart | Chụp danh sách sản phẩm trong giỏ, số lượng và tổng tiền. |
| 13 | Phụ trọng tâm | Modal voucher trong giỏ hàng | https://lazpe.store/cart | Chụp VoucherModal khi chọn voucher áp dụng. |
| 14 | Chính | Thanh toán | https://lazpe.store/checkout | Chụp địa chỉ, phương thức thanh toán, voucher, điểm/xu và tổng đơn. |
| 15 | Phụ trọng tâm | Modal địa chỉ thanh toán | https://lazpe.store/checkout | Chụp AddressModal khi thêm hoặc sửa địa chỉ nhận hàng. |
| 16 | Chính | Kết quả đặt hàng/hóa đơn | https://lazpe.store/Invoice | Chụp mã đơn, trạng thái thanh toán và tổng tiền sau khi đặt hàng. |
| 17 | Chính | Hồ sơ cá nhân tổng quan | https://lazpe.store/profile | Chụp ProfileHeader, điểm thưởng, hạng thành viên và menu tab. |
| 18 | Chính | Profile - tab Thông tin cá nhân | https://lazpe.store/profile | Chụp thông tin cá nhân và nút mở EditProfileModal. |
| 19 | Chính | Profile - tab Đơn hàng | https://lazpe.store/profile | Chụp danh sách đơn hàng; không cần chụp từng tab trạng thái. |
| 20 | Chính | Profile - chi tiết đơn hàng | https://lazpe.store/profile | Chụp OrderDetailView gồm sản phẩm, địa chỉ, thanh toán và trạng thái. |
| 21 | Chính | Profile - tab Ví | https://lazpe.store/profile | Chụp số dư ví, lịch sử giao dịch và thao tác bảo mật ví. |
| 22 | Chính | Profile - tab Voucher | https://lazpe.store/profile | Chụp voucher đã lưu và điều kiện sử dụng. |
| 23 | Chính | Profile - tab Loyalty/điểm thưởng | https://lazpe.store/profile | Chụp điểm hiện có, hạng thành viên, lịch sử điểm và điểm danh. |
| 24 | Chính | Profile - tab Hồ sơ bé/Theo dõi bé | https://lazpe.store/profile | Chụp thông tin bé, biểu đồ tăng trưởng hoặc lịch tiêm chủng. |
| 25 | Phụ trọng tâm | Thông báo, Wishlist hoặc So sánh | https://lazpe.store/notifications, https://lazpe.store/wishlist, https://lazpe.store/compare | Chụp một trong các màn hình hỗ trợ khách hàng sau mua hoặc trước mua. |

*Bảng 5.78: Danh sách màn hình admin cần chụp*

| STT | Mức độ | Màn hình cần chụp | Đường dẫn | Nội dung cần thể hiện |
|---|---|---|---|---|
| 1 | Chính | Dashboard admin | https://lazpe.store/admin | Chụp sidebar, header và các thẻ chỉ số tổng quan. |
| 2 | Chính | Danh sách sản phẩm | https://lazpe.store/admin/products | Chụp bảng sản phẩm, bộ lọc, tìm kiếm và thao tác nhanh. |
| 3 | Chính | Form thêm/sửa sản phẩm | https://lazpe.store/admin/products/new | Chụp thông tin chung, danh mục, thương hiệu, ảnh, giá và kho. |
| 4 | Chính | Quản lý thuộc tính sản phẩm | https://lazpe.store/admin/products/[id]/options | Chụp danh sách option và giá trị option. |
| 5 | Chính | Quản lý biến thể sản phẩm | https://lazpe.store/admin/products/[id]/variants | Chụp bảng biến thể, SKU, giá, tồn kho và trạng thái. |
| 6 | Phụ trọng tâm | Import sản phẩm | https://lazpe.store/admin/products/import | Chụp màn hình import và modal xử lý lỗi/xung đột nếu có. |
| 7 | Chính | Danh sách đơn hàng | https://lazpe.store/admin/orders | Chụp thẻ tổng quan, bộ lọc và bảng đơn hàng. |
| 8 | Chính | Chi tiết đơn hàng | https://lazpe.store/admin/orders/[id] | Chụp thông tin khách, địa chỉ, sản phẩm, tổng tiền và action bar. |
| 9 | Phụ trọng tâm | Modal hủy/trả hàng | https://lazpe.store/admin/orders/[id] | Chụp CancelOrderModal hoặc ReturnOrderModal. |
| 10 | Phụ trọng tâm | In phiếu giao hàng | https://lazpe.store/admin/orders/[id]/print | Chụp mẫu phiếu giao hàng hoặc màn hình batch print. |
| 11 | Chính | Quản lý voucher | https://lazpe.store/admin/vouchers | Chụp danh sách voucher, trạng thái, thời hạn và thao tác. |
| 12 | Chính | Form tạo/sửa voucher | https://lazpe.store/admin/vouchers/create | Chụp điều kiện áp dụng, loại giảm giá, số lượng và thời hạn. |
| 13 | Chính | Flash sale | https://lazpe.store/admin/flash-sales | Chụp danh sách chương trình và sản phẩm tham gia sale. |
| 14 | Chính | Combo sản phẩm | https://lazpe.store/admin/combo | Chụp danh sách/form combo và modal chọn sản phẩm. |
| 15 | Chính | Quản lý người dùng | https://lazpe.store/admin/users | Chụp thống kê, bộ lọc và bảng tài khoản. |
| 16 | Phụ trọng tâm | Chi tiết người dùng | https://lazpe.store/admin/users/[id] | Chụp thông tin tài khoản và trạng thái người dùng. |
| 17 | Chính | Phân quyền người dùng | https://lazpe.store/admin/permissions | Chụp tab người dùng, quyền được gán và thao tác cấp/thu hồi quyền. |
| 18 | Chính | Mẫu quyền | https://lazpe.store/admin/role-templates | Chụp danh sách hoặc form tạo mẫu quyền. |
| 19 | Chính | Đánh giá - thống kê | https://lazpe.store/admin/reviews | Chụp AnalyticsTab với chỉ số đánh giá. |
| 20 | Chính | Đánh giá - kiểm duyệt | https://lazpe.store/admin/reviews | Chụp ModerationTab và modal duyệt/ẩn/từ chối đánh giá. |
| 21 | Chính | Loyalty - tổng quan | https://lazpe.store/admin/loyalty | Chụp dashboard loyalty, số điểm, thành viên và voucher. |
| 22 | Chính | Loyalty - chính sách tích/đổi điểm | https://lazpe.store/admin/loyalty | Chụp chính sách tích điểm, đổi điểm hoặc VoucherRedemptionConfig. |
| 23 | Chính | Loyalty - hạng thành viên/voucher tháng | https://lazpe.store/admin/loyalty | Chụp cấu hình hạng thành viên, đặc quyền và voucher hàng tháng. |
| 24 | Chính | Banner và thông báo | https://lazpe.store/admin/banners, https://lazpe.store/admin/notifications | Chụp form/preview banner và danh sách hoặc form thông báo. |
| 25 | Chính | Thống kê doanh thu/sản phẩm | https://lazpe.store/admin/statistics | Chụp RevenueTab hoặc ProductsTab với biểu đồ và bộ lọc thời gian. |
